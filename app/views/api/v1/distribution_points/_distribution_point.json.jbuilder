json.extract! distribution_point, :active, :name, :address, :city, :county, :state, :zip, :created_at, :updated_at, :updated_by, :source, :notes, :longitude, :latitude, :google_place_id, :id
